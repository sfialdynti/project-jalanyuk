...
<html lang="en">
  <head>
    ...
    <title>Tambah Destinasi - JalanYuk </title>
    <!-- plugins:css -->
              ...
              <div class="grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/destinasi/create" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                        <label for="nama_destinasi">Nama Destinasi</label>
                        <input type="text" class="form-control @error('nama_destinasi') is-invalid @enderror" id="nama_destinasi" name="nama_destinasi" placeholder="Nama Destinasi" value="{{ old('nama_destinasi') }}">
