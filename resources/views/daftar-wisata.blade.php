...
<html lang="en">
  <head>
    ...
    <title>Daftar Tempat Wisata - JalanYuk </title>
    <!-- plugins:css -->
              ...
              <div class=" grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-4">
                      <div class=" col-md-6">
                        <h5 class=""><a href="/wisata/create" class=" text-decoration-none">Tambah Tempat Wisata</a></h5>
                      </div>
                      <div class=" col-md-6" style="height: 20px">
                        <form class="search-form" action="/daftar-wisata" method="post">
                          @csrf
                          ...
                          <tr>
                            ...
                            <td>
                              <label class="badge badge-warning">
                                <a href="wisata/edit/{{ $item->id }}" class=" text-decoration-none text-white">Edit</a>
                              </label>
                              <label class="badge badge-danger">
                                <a href="wisata/delete/{{ $item->id }}" class=" text-decoration-none text-white" onclick="return window.confirm('Yakin hapus data ini?')">Hapus</a>
                              </label>
                            </td>
                          </tr>
                          @endforeach
