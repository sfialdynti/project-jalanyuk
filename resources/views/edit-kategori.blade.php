...
<html lang="en">
  <head>
    ...
    <title>Edit Kategori - JalanYuk </title>
    <!-- plugins:css -->
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/kategori/update/{{ $kategori->id }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" placeholder="deskripsi" value="{{ old('deskripsi', $kategori->deskripsi ?? '') }}">
                        @error('deskripsi')
                          <div class=" invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
