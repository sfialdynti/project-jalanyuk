...
<html lang="en">
  <head>
    ...
    <title>Tambah Tempat Wisata - JalanYuk </title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tambah Data Tempat Wisata</h4>
                    <form class="forms-sample" action="/wisata/create" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                        <label for="nama_wisata">Nama Tempat Wisata</label>
                        <input type="text" class="form-control @error('nama_wisata') is-invalid @enderror" id="nama_wisata" name="nama_wisata" placeholder="Nama Wisata" value="{{ old('nama_wisata') }}">
                        @error('nama_wisata')
                      ...
                      <div class="form-group">
                        <label for="logintude">Longitude</label>
