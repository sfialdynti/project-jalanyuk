...
<html lang="en">
  <head>
    ...
    <title>Edit Destinasi - JalanYuk </title>
    <!-- plugins:css -->
              ...
              <div class="grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="/destinasi/update/{{ $destinasi->id }}" method="post" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                        <label for="nama_destinasi">Nama Destinasi</label>
                        <input type="text" class="form-control @error('nama_destinasi') is-invalid @enderror" id="nama_destinasi" name="nama_destinasi" placeholder="Nama Destinasi" value="{{ old('nama_destinasi', $destinasi->nama_destinasi ?? '') }}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" placeholder="deskripsi" value="{{ old('deskripsi', $destinasi->deskripsi ?? '') }}">
                        @error('deskripsi')
                          <div class=" invalid-feedback">{{ $message }}</div>
                        @enderror
                      </div>
